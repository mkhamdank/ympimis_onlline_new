                    ...
                    <div class="card-body" style="padding: 0px">
                        <div class="col-md-12" style="padding: 10px; overflow-x: scroll;">
                            <table class="table table-bordered user-table no-wrap" id="tableMaterial">
                                <thead>
                                    <tr>
                                        <th style="background-color: #3f50b5;color: white !important;">Created At</th>
                                        <th style="background-color: #3f50b5;color: white !important;">Mvt</th>
                                        <th style="background-color: #3f50b5;color: white !important;">Result Date</th>
                                        <th style="background-color: #3f50b5;color: white !important;">Material</th>
                                        <th style="background-color: #3f50b5;color: white !important;">Material Desc.</th>
                                        <th style="background-color: #3f50b5;color: white !important;">Quantity</th>
                                    </tr>
                                </thead>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function fetchData() {
            ...
            $.get('{{ url('fetch/transaction_log') }}', data, function(result, status, xhr) {
                if (result.status) {
                    ...
                    for (var i = 0; i < result.log.length; i++) {
                        bodyTable += '<tr>';
                        bodyTable += '<td style="text-align: center; width: 25%;">';
                        bodyTable += result.log[i].created_at + '</td>';
                        bodyTable += '<td style="text-align: center; width: 10%;">';
                        bodyTable += result.log[i].mvt + '</td>';
                        bodyTable += '<td style="text-align: center; width: 10%;">';
                        bodyTable += result.log[i].result_date + '</td>';
                        bodyTable += '<td style="text-align: center; width: 10%;">';
                        bodyTable += result.log[i].material_number + '</td>';
                        bodyTable += '<td style="text-align: left; width: 25%;">';
                        bodyTable += result.log[i].material_description + '</td>';
                        bodyTable += '<td style="text-align: center; width: 10%;">';
                        bodyTable += result.log[i].quantity + '</td>';
                        bodyTable += '</tr>';
                    }
