                            ...
                            <table class="table table-bordered user-table no-wrap" id="tableMaterial">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="background-color: #3f50b5;color: white !important;">L/T Production</th>
                                        <th style="background-color: #3f50b5;color: white !important;">L/T Order</th>
                                    </tr>
                                </thead>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function fetchData() {
            ...
            $.get('{{ url('fetch/material_master') }}', data, function(result, status, xhr) {
                if (result.status) {
                    ...
                    for (var i = 0; i < result.materials.length; i++) {
                        bodyTable += '<tr>';
                        bodyTable += '<td style="width: 20%; text-align: center;">';
                        bodyTable += result.materials[i].category + '</td>';
                        bodyTable += '<td style="width: 15%; text-align: center;">';
                        bodyTable += result.materials[i].material_number + '</td>';
                        bodyTable += '<td style="width: 35%; text-align: left;">';
                        bodyTable += result.materials[i].material_description + '</td>';
                        bodyTable += '<td style="width: 15%; text-align: center;">';
                        bodyTable += (result.materials[i].lt_production || '-') + '</td>';
                        bodyTable += '<td style="width: 15%; text-align: center;">';
                        bodyTable += (result.materials[i].lt_order || '-') + '</td>';
                        bodyTable += '</tr>';
                    }
