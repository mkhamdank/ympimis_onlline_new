                            ...
                            <table class="table table-bordered user-table no-wrap" id="tableMaterial">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="background-color: #3f50b5;color: white !important;">Storage Location</th>
                                        <th style="background-color: #3f50b5;color: white !important;">Stock</th>
                                    </tr>
                                </thead>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function fetchData() {
            ...
            $.get('{{ url('fetch/stock_inquiry') }}', data, function(result, status, xhr) {
                if (result.status) {
                    ...
                    for (var i = 0; i < result.stocks.length; i++) {
                        bodyTable += '<tr>';
                        bodyTable += '<td>' + result.stocks[i].category + '</td>';
                        bodyTable += '<td>' + result.stocks[i].material_number + '</td>';
                        bodyTable += '<td>' + result.stocks[i].material_description + '</td>';
                        bodyTable += '<td>' + result.stocks[i].storage_location + '</td>';
                        bodyTable += '<td>' + result.stocks[i].stock + '</td>';
                        bodyTable += '</tr>';
                    }
