    ...
    <form role="form">
      <div class="box-body">
        <div class="form-group row" align="right">
          <label class="col-sm-5">Origin Group Code</label>
          <div class="col-sm-5" align="left">
            {{$origin_group->origin_group_code}}
          </div>
        </div>
        <div class="form-group row" align="right">
          <label class="col-sm-5">Origin Group Name</label>
          <div class="col-sm-5" align="left">
