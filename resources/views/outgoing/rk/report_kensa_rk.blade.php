...
<script type="text/javascript">
    ...
    function fetchData() {
        ...
        $.get('{{ url("fetch/kensa/rk/report") }}',data,  function(result, status, xhr){
            if(result.status){
                ...
                for (var i = 0; i < result.outgoing.length; i++) {
                    ...
                    //     // var url = '{{url("index/outgoing/rk/input/lot_out/")}}'+'/'+result.outgoing[i].serial_number+'/'+result.outgoing[i].check_date;
