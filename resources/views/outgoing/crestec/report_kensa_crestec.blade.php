                            ...
                            <table class="table user-table no-wrap" id="tableKensa">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="background-color: #3f50b5;color: white !important;">Section</th>
...
<script type="text/javascript">
    ...
    function fetchData() {
        ...
        $.get('{{ url("fetch/kensa/crestec/report") }}',data,  function(result, status, xhr){
            if(result.status){
                ...
                for (var i = 0; i < result.outgoing.length; i++) {
                    ...
                    bodyTable += '<td>'+getFormattedDateTime(new Date(result.outgoing[i].check_date))+'</td>';
                    ...
                    bodyTable += '<td>'+result.outgoing[i].ng_name.split('_')[0]+'</td>';
                    bodyTable += '<td>'+result.outgoing[i].ng_name.split('_')[1]+'</td>';
                    bodyTable += '<td>'+result.outgoing[i].ng_name.split('_')[2]+'</td>';
                    ...
                    if (result.outgoing[i].lot_status == 'LOT OUT' && result.outgoing[i].recheck_status == 'Checked') {
                        ...
                        var url = '{{url("index/outgoing/crestec/input/lot_out/")}}'+'/'+result.outgoing[i].serial_number+'/'+result.outgoing[i].check_date;
