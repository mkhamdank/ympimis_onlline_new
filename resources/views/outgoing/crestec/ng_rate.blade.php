			          ...
			          <table class="table user-table no-wrap" style="font-size:15px" id="tableDetail">
			          	<thead style="background-color: #3f50b5;color: white !important">
			          		<tr>
			          			...
			          			<th style="background-color: #3f50b5;color: white !important;border:1px solid black;font-size: 13px;width: 1%;">Prod. Result</th>
			          			<th style="background-color: #3f50b5;color: white !important;border:1px solid black;font-size: 13px;width: 1%;">Qty OK</th>
			          			<th style="background-color: #3f50b5;color: white !important;border:1px solid black;font-size: 13px;width: 2%;">Section</th>
			          			<th style="background-color: #3f50b5;color: white !important;border:1px solid black;font-size: 13px;width: 1%;">Code</th>
...
<script>
	...
	function fetchData() {
		...
		$.get('{{ url("fetch/outgoing/ng_rate/crestec") }}',data, function(result, status, xhr) {
			if(xhr.status == 200){
				if(result.status){
					var categories = [];
					var checkes = [];
					...
					Highcharts.chart('container', {
					    ...
					    title: {
					        text: 'Production NG Rate PT. CRESTEC INDONESIA',
					        style:{
					        	fontWeight:'bold'
					        }
					    },
	...
	function showModalDetail(categories) {
		...
		$.get('{{ url("fetch/outgoing/ng_rate/detail/crestec") }}',data, function(result, status, xhr) {
			if(xhr.status == 200){
				if(result.status){
					...
					bodyDetailTotal += '<td style="color:black;text-align:right;padding:5px">TOTAL NG</td>';
					bodyDetailTotal += '<td style="color:black;border-left:3px solid black;text-align:left;padding:5px">'+total_ng+'</td>';
					bodyDetailTotal += '</tr>';
					bodyDetailTotal += '<tr style="border-bottom:3px solid black;border-top:3px solid black;background-color:#cddc39;color:black;font-size:15px">';
					bodyDetailTotal += '<td style="color:black;text-align:right;padding:5px">TOTAL CHECK</td>';
					bodyDetailTotal += '<td style="color:black;border-left:3px solid black;text-align:left;padding:5px">'+total_check+'</td>';
					bodyDetailTotal += '</tr>';
					bodyDetailTotal += '</tr>';
					bodyDetailTotal += '<tr style="border-bottom:3px solid black;border-top:3px solid black;background-color:#cddc39;color:black;font-size:15px">';
					bodyDetailTotal += '<td style="color:black;text-align:right;padding:5px">NG RATE</td>';
					bodyDetailTotal += '<td style="color:black;border-left:3px solid black;text-align:left;padding:5px">'+((total_ng / total_check) * 100).toFixed(2)+' %</td>';
					bodyDetailTotal += '</tr>';
