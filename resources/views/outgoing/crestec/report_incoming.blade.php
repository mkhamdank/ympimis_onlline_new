                        ...
                        <h4 style="padding: 0px">Filter</h4>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <a href="{{ url('index/incoming/crestec/report') }}" class="btn btn-danger">Clear</a>
...
<script type="text/javascript">
    ...
    function fetchData() {
        ...
        $.get('{{ url("fetch/incoming/crestec/report") }}',data,  function(result, status, xhr){
            if(result.status){
                ...
                $.each(result.incoming, function(key, value) {
                    ...
                    for (var i = 0; i < jumlah; i++) {
                        tableData += '<tr>';
                        tableData += '<td style="text-align:right">'+ value.created +'</td>';
                        tableData += '<td style="text-align:right">'+ value.invoice +'</td>';
                        tableData += '<td style="text-align:left">'+ value.inspection_level +'</td>';
                        tableData += '<td style="text-align:right">'+ value.lot_number +'</td>';
                        tableData += '<td style="text-align:left">'+ value.material_number +'</td>';
                        tableData += '<td style="text-align:left">'+ value.material_description +'</td>';
                        tableData += '<td style="text-align:left">'+ value.hpl +'</td>';
                        tableData += '<td style="text-align:right">'+ value.qty_rec +'</td>';
                        ...
                        tableData += '<td style="vertical-align:middle;text-align:left">'+ value.status_lot +'</td>';
                        tableData += '</tr>';
                    }
                    index++;
                });
