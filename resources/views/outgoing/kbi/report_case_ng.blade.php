                            ...
                            <table class="table user-table no-wrap" id="tableReport">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="background-color: #3f50b5;color: white !important; width: 3%;">Date</th>
                                        <th style="background-color: #3f50b5;color: white !important; width: 2%;">Product</th>
                                        <th style="background-color: #3f50b5;color: white !important; width: 2%;">NG</th>
                                        <th style="background-color: #3f50b5;color: white !important; width: 1%;">Line</th>
                                        <th style="background-color: #3f50b5;color: white !important; width: 2%;">Created At</th>
                                        <th style="background-color: #3f50b5;color: white !important; width: 2%;">Status</th>
                                    </tr>
                                </thead>
...
<script type="text/javascript">
    ...
    function fetchData() {
        ...
        $.get('{{ url("fetch/case_ng/kbi") }}',data,  function(result, status, xhr){
            if(result.status){
