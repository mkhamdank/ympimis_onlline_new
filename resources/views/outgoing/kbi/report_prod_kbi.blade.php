                            ...
                            <table class="table user-table no-wrap" id="tableKensa">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="background-color: #3f50b5;color: white !important;color: black">Total OK</th>
                                        <th style="background-color: #3f50b5;color: white !important;color: black">Total NG</th>
...
<script type="text/javascript">
    ...
    function fetchData() {
        ...
        $.get('{{ url("fetch/production_check/kbi/report") }}', data, function(result, status, xhr){
            if(result.status){
